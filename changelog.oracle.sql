...
--changeset support.liquibase.net:1585673761195-1
...
--changeset support.liquibase.net:1585673761195-2
...
--changeset support.liquibase.net:1585673761195-3
...
--changeset support.liquibase.net:1585673761195-4
...
--changeset support.liquibase.net:1585673761195-5
...
--changeset support.liquibase.net:1585673761195-6
...
--changeset support.liquibase.net:1585673761195-8
...
--changeset support.liquibase.net:1585673761195-9
...
--changeset support.liquibase.net:1585673761195-10
...
--changeset support.liquibase.net:1585673761195-11
...
--changeset support.liquibase.net:1585673761195-12
...
--changeset support.liquibase.net:1585673761195-13
CREATE SEQUENCE DEPARTMENTS_SEQ START WITH 280 INCREMENT BY 10 MAXVALUE 9990 NOCACHE;

--changeset support.liquibase.net:1585673761195-14
CREATE SEQUENCE EMPLOYEES_SEQ START WITH 207 MAXVALUE 9999999999999999999999999999 NOCACHE;

--changeset support.liquibase.net:1585673761195-15
CREATE SEQUENCE LOCATIONS_SEQ START WITH 3300 INCREMENT BY 100 MAXVALUE 9900 NOCACHE;

--changeset support.liquibase.net:1585673761195-16
CREATE TABLE SALESTABLE (ID NUMBER(*, 0) NOT NULL, NAME VARCHAR2(20 BYTE), REGION VARCHAR2(20 BYTE), MARKET VARCHAR2(20 BYTE));

--changeset support.liquibase.net:1585673761195-17
CREATE TABLE T_TABLE82 (ID NUMBER(*, 0) NOT NULL, NAME VARCHAR2(20 BYTE), REGION VARCHAR2(20 BYTE), MARKET VARCHAR2(20 BYTE));

--changeset support.liquibase.net:1585673761195-18
ALTER TABLE EMPLOYEES ADD CONSTRAINT EMP_SALARY_MIN CHECK (salary > 0);

--changeset support.liquibase.net:1585673761195-19
CREATE UNIQUE INDEX EMP_EMAIL_UK ON EMPLOYEES(EMAIL);

--changeset support.liquibase.net:1585673761195-20
ALTER TABLE EMPLOYEES ADD CONSTRAINT EMP_EMAIL_UK UNIQUE (EMAIL) USING INDEX EMP_EMAIL_UK;

--changeset support.liquibase.net:1585673761195-22
CREATE INDEX DEPT_LOCATION_IX ON DEPARTMENTS(LOCATION_ID);

--changeset support.liquibase.net:1585673761195-23
CREATE INDEX EMP_DEPARTMENT_IX ON EMPLOYEES(DEPARTMENT_ID);

--changeset support.liquibase.net:1585673761195-24
CREATE INDEX EMP_JOB_IX ON EMPLOYEES(JOB_ID);

--changeset support.liquibase.net:1585673761195-25
CREATE INDEX EMP_MANAGER_IX ON EMPLOYEES(MANAGER_ID);

--changeset support.liquibase.net:1585673761195-26
CREATE INDEX EMP_NAME_IX ON EMPLOYEES(LAST_NAME, FIRST_NAME);

--changeset support.liquibase.net:1585673761195-27
CREATE INDEX LOC_CITY_IX ON LOCATIONS(CITY);

--changeset support.liquibase.net:1585673761195-28
CREATE INDEX LOC_COUNTRY_IX ON LOCATIONS(COUNTRY_ID);

--changeset support.liquibase.net:1585673761195-29
CREATE INDEX LOC_STATE_PROVINCE_IX ON LOCATIONS(STATE_PROVINCE);

--changeset support.liquibase.net:1585673761195-30
ALTER TABLE COUNTRIES ADD CONSTRAINT COUNTR_REG_FK FOREIGN KEY (REGION_ID) REFERENCES REGIONS (REGION_ID);

--changeset support.liquibase.net:1585673761195-31
ALTER TABLE DEPARTMENTS ADD CONSTRAINT DEPT_LOC_FK FOREIGN KEY (LOCATION_ID) REFERENCES LOCATIONS (LOCATION_ID);

--changeset support.liquibase.net:1585673761195-32
ALTER TABLE DEPARTMENTS ADD CONSTRAINT DEPT_MGR_FK FOREIGN KEY (MANAGER_ID) REFERENCES EMPLOYEES (EMPLOYEE_ID);

--changeset support.liquibase.net:1585673761195-33
ALTER TABLE EMPLOYEES ADD CONSTRAINT EMP_DEPT_FK FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENTS (DEPARTMENT_ID);

--changeset support.liquibase.net:1585673761195-34
ALTER TABLE EMPLOYEES ADD CONSTRAINT EMP_JOB_FK FOREIGN KEY (JOB_ID) REFERENCES JOBS (JOB_ID);

--changeset support.liquibase.net:1585673761195-35
ALTER TABLE EMPLOYEES ADD CONSTRAINT EMP_MANAGER_FK FOREIGN KEY (MANAGER_ID) REFERENCES EMPLOYEES (EMPLOYEE_ID);

--changeset support.liquibase.net:1585673761195-36
